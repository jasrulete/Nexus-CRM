...
// The config imports the Sentry build plugin; a cold import can take several
// seconds, which is more than vitest's default per-test budget.
describe("next.config output mode", { timeout: 30_000 }, () => {
