...
| Build and test health | typecheck, eslint, 414 unit tests (coverage-gated), 44 e2e tests incl. axe scans, production build all green | GitHub Actions badge in the README |
...
414 unit tests cover library modules and the server actions (against a real
