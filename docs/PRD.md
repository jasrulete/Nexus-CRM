...
| Build and test health | typecheck, eslint, 416 unit tests (coverage-gated), 45 e2e tests incl. axe scans, production build all green | GitHub Actions badge in the README |
