...
model draft only when it is shaped like an email (`isEmailShaped`), after the groq leg twice
returned an injected note verbatim as the draft. W13's remaining scope — the nonce, the §3
